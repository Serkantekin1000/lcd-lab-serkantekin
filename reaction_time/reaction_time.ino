...
void reactionGame() {
  ...
  lcd.print("get ready, players!"); // Inform the player to get ready
  ...
  int time = random("3000,6000");
  delay(time);  //3 to 6 seconds (3000-6000 ms)

  lcd.clear();                 
  lcd.print("press fast");  // Ask the player to press the button as fast as possible
